...
//        setOnIceCandidate
    ...
    void updateSessionForConnection(String streamRoomId, ConnectionType connectionType, long sessionId){
...
//    }
//
    JanusConnection getConnectionWithSession(String streamRoomId, ConnectionType connectionType){
