...
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_init(
        JNIEnv *env,
        jobject thiz,
        jobject connection
) {
...
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_deinit(
        JNIEnv *env,
        jobject thiz
) {
    try {
...
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_createThread(
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_getThread(
        JNIEnv *env,
        jobject thiz,
        jstring thread_id
) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_listThreads(
        JNIEnv *env,
        jobject thiz,
        jstring context_id,
        jlong skip,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_sendMessage(
        JNIEnv *env,
        jobject thiz,
        jstring thread_id,
        jbyteArray public_meta,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_listMessages(
        JNIEnv *env,
        jobject thiz,
        jstring thread_id,
        jlong skip,
    ...
    ctx.callResultEndpointApi<jobject>(
            &result,
            [&ctx, &thiz, &thread_id, &skip, &limit, &sort_order, &last_id, &query_as_json, &sort_by]() {
                jclass pagingListCls = ctx->FindClass(
                        "com/simplito/java/privmx_endpoint/model/PagingList");
                jmethodID pagingListInitMID = ctx->GetMethodID(pagingListCls, "<init>",
                                                               "(Ljava/lang/Long;Ljava/util/List;)V");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_deleteThread(
        JNIEnv *env,
        jobject thiz,
        jstring thread_id
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_deleteMessage(
        JNIEnv *env,
        jobject thiz,
        jstring message_id
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_updateThread(
        JNIEnv *env,
        jobject thiz,
        jstring thread_id,
        jobject users,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_getMessage(
        JNIEnv *env,
        jobject thiz,
        jstring message_id
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_updateMessage(
        JNIEnv *env,
        jobject thiz,
        jstring message_id,
        jbyteArray public_meta,
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_subscribeFor(
        JNIEnv *env,
        jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_thread_ThreadApi_unsubscribeFrom(
        JNIEnv *env,
        jobject thiz,
