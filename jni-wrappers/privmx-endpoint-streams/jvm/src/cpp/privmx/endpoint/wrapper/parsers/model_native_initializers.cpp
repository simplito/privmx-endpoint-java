...
#include "privmx/endpoint/wrapper/streams/model_native_initializers.h"
...
//        }
        ...
        jobject streamPublishResult2Java(JniContextUtils &ctx, privmx::endpoint::stream::StreamPublishResult streamPublishResult_c){
            jclass itemCls = ctx->FindClass(
                    "com/simplito/java/privmx_endpoint/model/streams/StreamPublishResult");
            ...
            jmethodID initItemMID = ctx->GetMethodID(
                    ...
                    "Lcom/simplito/java/privmx_endpoint/model/streams/PublishedStreamData;"      // data
                    ")V"
            );
