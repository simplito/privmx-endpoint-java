...
//StreamSettingsJNI::StreamSettingsJNI(JNIEnv *env, jobject jstreamJoinSettings) {
StreamSettingsJNI::StreamSettingsJNI(JNIEnv *env) {
    JniContextUtils ctx(env);

    javaVM = nullptr;
    env->GetJavaVM(&this->javaVM);
//    this->cls = ctx->GetObjectClass(streamSettings);
