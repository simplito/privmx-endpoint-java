...
Java_com_simplito_java_privmx_1endpoint_modules_core_Connection_getConnectionId(JNIEnv *env,
                                                                                jobject thiz) {
    JniContextUtils ctx(env);
    jobject result;
    ctx.callResultEndpointApi<jobject>(
            ...
            [&ctx, &env, &thiz]() {
                return ctx.long2jLong(
                        (jlong) getConnection(env, thiz)->getConnectionId());
            });
...
Java_com_simplito_java_privmx_1endpoint_modules_core_Connection_listContexts(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jlong skip,
                                                                             jlong limit,
                                                                             jstring sort_order,
    ...
    jobject result;
    ctx.callResultEndpointApi<jobject>(&result,
...
extern "C" JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_core_Connection_disconnect(JNIEnv *env,
                                                                           jobject thiz) {
    JniContextUtils ctx(env);
...
extern "C" JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_core_Connection_setCertsPath(JNIEnv *env,
                                                                             jclass clazz,
                                                                             jstring certs_path) {
    JniContextUtils ctx(env);
...
extern "C" JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_core_Connection_connect(JNIEnv *env, jclass clazz,
    ...
    ctx.callResultEndpointApi<jobject>(&result,
                                       [&ctx, &clazz, &user_priv_key, &solution_id, &bridge_url]() {
                                           ...
                                           *api = connection;
                                           jobject result = ctx->NewObject(clazz, initMID,
                                                                           ctx.long2jLong(
                                                                                   (jlong) api),
                                                                           ctx.long2jLong(
                                                                                   api->getConnectionId()));
...
extern "C" JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_core_Connection_connectPublic(JNIEnv *env,
                                                                              jclass clazz,
                                                                              jstring solution_id,
                                                                              jstring bridge_url) {
    JniContextUtils ctx(env);
    ...
    ctx.callResultEndpointApi<jobject>(&result, [&ctx, &clazz, &solution_id, &bridge_url]() {
        ...
        privmx::endpoint::core::Connection connection = privmx::endpoint::core::Connection::connectPublic(
                ctx.jString2string(solution_id), ctx.jString2string(bridge_url));
        auto *api = new privmx::endpoint::core::Connection();
        *api = connection;
        jobject result = ctx->NewObject(clazz, initMID, ctx.long2jLong((jlong) api),
