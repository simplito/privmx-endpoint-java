...
Java_com_simplito_java_privmx_1endpoint_modules_event_EventApi_init(
        JNIEnv *env,
        jobject thiz,
        jobject connection
) {
...
Java_com_simplito_java_privmx_1endpoint_modules_event_EventApi_deinit(
        JNIEnv *env,
        jobject thiz
) {
    try {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_event_EventApi_emitEvent(
        JNIEnv *env,
        jobject thiz,
        jstring context_id,
        jobject users,
