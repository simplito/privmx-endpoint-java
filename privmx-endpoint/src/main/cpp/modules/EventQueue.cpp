...
Java_com_simplito_java_privmx_1endpoint_modules_core_EventQueue_emitBreakEvent(
        JNIEnv *env,
        jclass clazz
) {
...
Java_com_simplito_java_privmx_1endpoint_modules_core_EventQueue_waitEvent(
        JNIEnv *env,
        jclass clazz
) {
    JniContextUtils ctx(env);
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_simplito_java_privmx_1endpoint_modules_core_EventQueue_getEvent(
        JNIEnv *env,
        jclass clazz
) {
    JniContextUtils ctx(env);
