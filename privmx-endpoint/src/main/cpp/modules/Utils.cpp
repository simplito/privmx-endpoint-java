...
Java_com_simplito_java_privmx_1endpoint_model_utils_Utils_trim(JNIEnv *env,
                                                               jclass clazz,
                                                               jstring data) {
...
Java_com_simplito_java_privmx_1endpoint_model_utils_Utils_split(JNIEnv *env,
                                                                jclass clazz,
                                                                jstring data,
                                                                jstring delimiter) {
    JniContextUtils ctx(env);
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Utils_ltrim(JNIEnv *env,
                                                                jclass clazz,
                                                                jstring data) {
    JniContextUtils ctx(env);
    if (ctx.nullCheck(data, "Data")) return nullptr;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Utils_rtrim(JNIEnv *env,
                                                                jclass clazz,
                                                                jstring data) {
    JniContextUtils ctx(env);
    if (ctx.nullCheck(data, "Data")) return nullptr;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Hex_encode(JNIEnv *env,
                                                               jclass clazz,
                                                               jbyteArray data) {
    JniContextUtils ctx(env);
    if (ctx.nullCheck(data, "Data")) return nullptr;
...
Java_com_simplito_java_privmx_1endpoint_model_utils_Hex_decode(JNIEnv *env,
                                                               jclass clazz,
                                                               jstring hex_data) {
    JniContextUtils ctx(env);
...
Java_com_simplito_java_privmx_1endpoint_model_utils_Hex_is(JNIEnv *env, jclass clazz,
                                                           jstring data) {
    JniContextUtils ctx(env);
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Base32_encode(JNIEnv *env,
                                                                  jclass clazz,
                                                                  jbyteArray data) {
    JniContextUtils ctx(env);
    if (ctx.nullCheck(data, "Data")) return nullptr;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Base32_decode(JNIEnv *env,
                                                                  jclass clazz,
                                                                  jstring base32_data) {
    JniContextUtils ctx(env);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Base32_is(JNIEnv *env,
                                                              jclass clazz,
                                                              jstring data) {
    JniContextUtils ctx(env);
    if (ctx.nullCheck(data, "Data")) return JNI_FALSE;;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Base64_encode(JNIEnv *env,
                                                                  jclass clazz,
                                                                  jbyteArray data) {
    JniContextUtils ctx(env);
    if (ctx.nullCheck(data, "Data")) return nullptr;
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Base64_decode(JNIEnv *env,
                                                                  jclass clazz,
                                                                  jstring base64_data) {
    JniContextUtils ctx(env);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_simplito_java_privmx_1endpoint_model_utils_Base64_is(JNIEnv *env,
                                                              jclass clazz,
                                                              jstring data) {
    JniContextUtils ctx(env);
    if (ctx.nullCheck(data, "Data")) return JNI_FALSE;;
